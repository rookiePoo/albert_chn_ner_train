  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(per_example_loss, label_ids, logits):
        ...
        precision = tf_metrics.precision(label_ids,predictions,num_labels,list(range(1,9)),average="macro")
        recall = tf_metrics.recall(label_ids,predictions,num_labels,list(range(1,9)),average="macro")
        f = tf_metrics.f1(label_ids,predictions,num_labels,list(range(1,9)),average="macro")
        #
        return {
